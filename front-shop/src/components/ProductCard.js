        ...
        <div className="card">
            ...
            <div className="card__buttons">
                ...
                {cart.includes(product) ?
                    <button className="button button__red" onClick={e => handleCart(e, product)}>Remove</button> : 
                    <button className="button button__orange" onClick={e => handleCart(e, product)}>Add to cart</button>
                }
            </div>
        </div>
      );     
